...
#ifndef LOBBY_COMMAND_BOWLPARTY_HPP
#define LOBBY_COMMAND_BOWLPARTY_HPP

#include "lobby/stk_command.hpp"
#include "network/moderation_toolkit/server_permission_level.hpp"
#include "utils/cpp2011.hpp"

class BowlPartyCommand : public STKCommand
{
    ServerPermissionLevel m_min_veto = PERM_REFEREE;
public:
    BowlPartyCommand() : STKCommand(true/*votable*/)
    {
        m_name = "bowlparty";
        m_args = {{nnwcli::CT_BOOL, "state", "State: on or off."}};
        m_description = "Enable or disable bowlparty: "
...
#endif // LOBBY_COMMAND_BOWLPARTY_HPP
