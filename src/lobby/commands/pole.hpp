...
#ifndef LOBBY_COMMAND_POLE_HPP
#define LOBBY_COMMAND_POLE_HPP

#include "lobby/stk_command.hpp"
#include "network/moderation_toolkit/server_permission_level.hpp"
#include "utils/cpp2011.hpp"

class PoleCommand : public STKCommand
{
    ServerPermissionLevel m_min_veto = PERM_REFEREE;
public:
    PoleCommand() : STKCommand(true/*votable*/)
    {
        m_name = "pole";
        m_args = {{nnwcli::CT_BOOL, "state", "State: yes or no"}};
