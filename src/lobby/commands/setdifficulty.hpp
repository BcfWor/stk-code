...
#ifndef LOBBY_COMMAND_SETDIFFICULTY_HPP
#define LOBBY_COMMAND_SETDIFFICULTY_HPP

#include "lobby/stk_command.hpp"
#include "network/moderation_toolkit/server_permission_level.hpp"
#include "utils/cpp2011.hpp"

class SetDifficultyCommand : public STKCommand
{
    ServerPermissionLevel m_override_perm = PERM_ADMINISTRATOR;
    ServerPermissionLevel m_min_veto = PERM_ADMINISTRATOR;
public:
    SetDifficultyCommand() : STKCommand(true/*votable*/)
    {
        m_name = "setdifficulty";
        m_args = {{nnwcli::CT_STRING, "name", "Difficulty: novice/intermediate/expert/supertux"}};
...
#endif // LOBBY_COMMAND_SETDIFFICULTY_HPP
