...
#ifndef LOBBY_COMMAND_CAKEPARTY_HPP
#define LOBBY_COMMAND_CAKEPARTY_HPP

#include "lobby/stk_command.hpp"
#include "network/moderation_toolkit/server_permission_level.hpp"
#include "utils/cpp2011.hpp"

class CakePartyCommand : public STKCommand
{
    ServerPermissionLevel m_min_veto = PERM_REFEREE;
public:
    CakePartyCommand() : STKCommand(true/*votable*/)
    {
        m_name = "cakeparty";
        m_args = {{nnwcli::CT_BOOL, "state", "State: on or off."}};
        m_description = "Enable or disable cakeparty: "
...
#endif // LOBBY_COMMAND_CAKEPARTY_HPP
