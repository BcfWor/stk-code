...
#ifndef LOBBY_COMMAND_ITEMLESS_HPP
#define LOBBY_COMMAND_ITEMLESS_HPP

#include "lobby/stk_command.hpp"
#include "network/moderation_toolkit/server_permission_level.hpp"
#include "utils/cpp2011.hpp"

class ItemlessCommand : public STKCommand
{
    ServerPermissionLevel m_min_veto = PERM_REFEREE;
public:
    ItemlessCommand() : STKCommand(true/*votable*/)
    {
        m_name = "itemless";
        m_args = {{nnwcli::CT_BOOL, "sum1", "State: on or off"}};
        m_description = "Enables or disables itemless mode.";
    }
...
#endif // LOBBY_COMMAND_ITEMLESS_HPP
