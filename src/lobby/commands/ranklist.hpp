...
#ifndef LOBBY_COMMAND_RANKLIST_HPP
#define LOBBY_COMMAND_RANKLIST_HPP

#include "lobby/stk_command.hpp"
#include "network/moderation_toolkit/server_permission_level.hpp"
#include "utils/cpp2011.hpp"

class RankListCommand : public STKCommand
{
...
public:
    ...
    RankListCommand() : STKCommand(false)
    {
        m_name = "ranklist";
        ...
        m_args = {};
        m_optargs = {{nnwcli::CT_UINTEGER, "page", "Page, starting from 1"}};
        ...
        m_description = "Shows the Soccer ranking list.";
    }
...
#endif // LOBBY_COMMAND_RANKLIST_HPP
