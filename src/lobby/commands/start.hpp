...
#ifndef LOBBY_COMMAND_START_HPP
#define LOBBY_COMMAND_START_HPP

#include "lobby/stk_command.hpp"
#include "network/moderation_toolkit/server_permission_level.hpp"
#include "utils/cpp2011.hpp"

class StartCommand : public STKCommand
{
...
public:
    ...
    StartCommand() : STKCommand(true/*votable*/)
    {
        m_name = "start";
        m_args = {};
        m_description = "Forces the game to start.";
    }

    virtual bool execute(nnwcli::CommandExecutorContext* context, void* data) OVERRIDE;
};

#endif // LOBBY_COMMAND_START_HPP
